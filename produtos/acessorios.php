...
<body>
  ...
  <!-- ------------------------------MENU ---------------------------------------------->       
      <div class="shadow-sm p-3 mb-5 bg-white rounded">
		...
		<!-- LOGO -->
            <a class="navbar-brand" href="teste.php"><img src="../images/logo/PAT___GLOW-removebg-preview.png" alt="logo"></a>
		<!-- /LOGO -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="../teste.php">Home</a>
                </li>
                <li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="crianca.php">Criança</a>
